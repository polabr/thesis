...
newF = TFile("selectedEventsTrueRecoBoth_withTrueTrkDir_withParticleEs_110424.root","recreate")
        ...
        for i in range(m):
            ...
            if (pdg == 13): # mu
                ...
                if ( momMu < 1.5 ):
                    ...
                    truthSel_truthMuonMom = momMu
                    truthsel_leadingAngMu = angMu

                    truthSel_trkDirMuX = pxMu
                    truthSel_trkDirMuY = pyMu
                    truthSel_trkDirMuZ = pzMu

                    truthSel_eMu = energyMu
        ...
        for i in range(n):
            ...
            if (pdg == 211 or pdg == -211): 
                ...
                if (recoMomPi > 0.07):
                    ...
                    recoSel_trkDirPiX = t.trackStartDirX[i]
                    recoSel_trkDirPiY = t.trackStartDirY[i]
                    recoSel_trkDirPiZ = t.trackStartDirZ[i]
            ...
            if (pdg == 13): # mu 
                ...
                if ( recoMomMu < 1.5 ):
                    ...
                    recoSel_trkDirMuX = t.trackStartDirX[i]
                    recoSel_trkDirMuY = t.trackStartDirY[i]
                    recoSel_trkDirMuZ = t.trackStartDirZ[i]
            ...
            if (pdg == 2212):
                ...
                if ( recoMomP > 0.30 and recoMomP < 1.0 ):
                    ...
                    recoSel_trkDirPX = t.trackStartDirX[i]
                    recoSel_trkDirPY = t.trackStartDirY[i]
                    recoSel_trkDirPZ = t.trackStartDirZ[i]
